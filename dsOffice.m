function c = dsOffice(varargin)
%
% created from neurostim/myRig
%
...
switch upper(computerName)
    case {'EXPERIMENTRIG','MU00175834'}
        ...
        c.screen.number     = 0;%2; % Use the second screen as the display for the subject
        c.screen.frameRate  = 59.9868;
        % Geometry
